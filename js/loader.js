(function () {
    ...
    var stageDom = document.getElementById((window._mrmcp || {})['script_id'] || "Mugeda_66cab5d431ac5952ab03860a")

    _mrmcp = (typeof _mrmcp == 'undefined') ? {} : _mrmcp;
_mrmcp['campaign_id'] = 'none';
_mrmcp['owner_id'] = '63c6c253a38f5c64245598d1';
_mrmcp['creative_id'] = '66cab5d431ac5952ab03860a';
...
var version = _mrmcp['version'] = _mrmcp['version'] != null ? _mrmcp['version'] : '0.4.46';
...
if(!window['_mrmcp']['loader']){
    var loadProcessHandleInstance = Mugeda['loadProcessHandleInstance'] = new Mugeda['loadProcessHandle']['bar']({
        'loadInfo': {"textLoading":"0","messageText":"","messageSize":"14","messageColor":"rgba(203, 164, 165, 255)","progressColor":"rgba(175, 184, 171, 255)","progressBackground":"#FFF","backgroundColor":"rgba(0, 0, 0, 0)","backgroundImage":(Array.isArray(_mrmcp.creative_path) ? _mrmcp.creative_path[0] : _mrmcp.creative_path ) + "images/65d571f41957d0cdd30a78bc.jpg","logoImage":(Array.isArray(_mrmcp.creative_path) ? _mrmcp.creative_path[0] : _mrmcp.creative_path ) + "images/66cab7d931ddf198ac00e5b7.png","progressPosition":"20","logoWidth":"280","style":"bar"},
        'thisAni': {
            'dom': null,
            'width': 320
        },
